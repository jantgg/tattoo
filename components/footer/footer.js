...
export default function Footer() {
  return (
    <div className="footer">
      <div className="description col-12 col-sm-3 col-md-3 col-lg-3 col-xl-3 col-xxl-3">
      ...
      <div className="contacts col-12 col-sm-3 col-md-3 col-lg-3 col-xl-3 col-xxl-3">
      ...
      <div className="socialmedia col-12 col-sm-3 col-md-3 col-lg-3 col-xl-3 col-xxl-3">
